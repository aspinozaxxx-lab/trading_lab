...
Обновлено: **2026-09-17, 10:15 МСК / 2026-09-17, 07:15 UTC**. Период разработки ограничен данными не позже
`2025-12-31`; рыночные исходы 2026 для текущих historical-гипотез защищены и не используются.

## V113 COMPLETE — REJECT_STAGE1

[Результат](V113_PRIVATE_DEMAND_BREADTH_RESULT.md): совместный рост трёх групп
рублёвых платежей → покупка MIX или деньги. CAGR **−8.8317% / −8.8898%** при
базовых / удвоенных издержках, Sharpe −0.43161 / −0.43490, MDD 45.5791% / 45.6031%.
Один прибыльный год из пяти; 13 roundtrips = 8 эпизодов + 5 переносов контрактов.
Контроль: −2.8094% / −2.8886%, 22 roundtrips. Все четыре расчёта исполнены полностью,
критических ошибок и неразрешённых состояний нет, конечная позиция закрыта.
Основной убыток до издержек −367 343.53 руб. Не Stage2; знак, категории и пороги
не менять. 56 публикаций / 53 пригодны / 3 явно недоступны; по 1 271 решению,
393 / 761 ненулевых целевых позиций, готовность 87.804878%. Остановки торгов сохранены.

Pre-outcome `8298d20c72c9c29c9443b49f0555e7c899ed27f6`, seal `5be99bb6fe81...`,
run `runs/v113_private_demand_breadth_v1_5be99bb6fe81`, завершён в 07:08:08 UTC,
manifest `14cdba1ff0f437d518e2ff90566938d2a453942b3959f04eb573492d8f732028`.
190 тестов локально и 190 на сервере. Хеши 20 артефактов и 128 исходных файлов,
56 состояний источника, два повтора целевых позиций и четыре повтора денежных
расчётов проверены на обеих машинах. Backup: 133 исходных файла / 358 704 385 байт
и 21 файл расчёта. **43 портфельных теста: 33 Stage1 reject + 1 Stage2 reject +
1 incomplete + 8 invalid**, активных Stage2/3 нет. Цель 20–50% не достигнута.
Это условный тест нынешних копий датированных PDF, не original PIT. Три маски
дат/заголовков объявлены до исходов; неполный исходный V1 сохранён.

Вопрос о расширении предварительного конкурса на equity AlgoPack 2020–2025 задан,
ответа пока нет. При разрешении — быстрый конкурс на уже скачанном. Иначе —
ограниченный обзор источника GLD: права, определения, датированная доступность,
без массового скачивания и текущих котировок 2026. [Точка продолжения](NEXT_SOURCE_REVIEW_20260916.md).
Основной архив в 07:13 UTC активен: 22 381 / 26 305 заданий (85.0827%), failed=0,
blocked=0; **16.098 ГБ всего, из них 13.619 ГБ AlgoPack**. Локально в 07:15 UTC
3.254 ГБ, частично копии сервера. 550 пропусков FUTOI остаются; рынок 2026 защищён.

### V113 pre-outcome — историческая запись
...
Текущий первый шаг 2026-09-17, 10:15 МСК / 07:15 UTC:
[V113 закрыт](V113_PRIVATE_DEMAND_BREADTH_RESULT.md): 43 портфельных теста,
активных Stage2/3 нет; экономический отказ −8.8317% / −8.8898%, все четыре расчёта
валидны. Не повторять расчёт, настройку или аудит без новой причины.
Вопрос о расширении допуска на equity AlgoPack 2020–2025 ожидает ответа. При явном
разрешении сначала быстрый конкурс на скачанных данных с отметкой об условности
нынешних версий истории. Иначе — ограниченный обзор физического золотого ETF по
[очереди](NEXT_SOURCE_REVIEW_20260916.md): права, определения, публикации и пересмотры,
без массового скачивания, текущих котировок 2026 и создания новой платформы.
Архив продолжает работу независимо; цель активна, доход 20–50% не подтверждён.

Исторический первый шаг 2026-09-17,10:04МСК /07:04UTC:
