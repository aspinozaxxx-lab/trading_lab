...
## Текущее исследование — V66 R1 завершён, 4 отсева / 0 кандидатов
...
1. V65 и [V66 R1](V66_FAST_VOLUME_RESULT.md) завершены: 8 отсеянных гипотез,
   0 Stage2 candidates. Следующий быстрый пакет — другой экономический механизм на
   имеющихся разрешённых данных, не перенастройка календаря/OHLCV и не новый сборщик
   по умолчанию. Сначала сверить реестр, затем короткий протокол и экономический run.
