...
## Текущее действие — AlgoPack отложен, бесплатный V64 подготовлен
...
Подготовлен V64: фиксированный календарный short SI перед номинальным налоговым сроком
против идентичного окна на 14 дней раньше. Новая календарная механика, не V19 Minfin
flow persistence, не настройка V49. Три исходных era 2008–2011/2012–2017/2018–2025,
никаких защищённых 2026 prices/outcomes. До результатов запечатываются code/config,
три costs, comparison и gates; synthetic tests 17/17. Следующий шаг — server preflight
и один economic run. Подробности: [V64_TAX_CALENDAR.md](V64_TAX_CALENDAR.md).
...
### P0 — V64 бесплатный календарный механизм

1. Покупку AlgoPack не продолжать: пользователь отложил её 2026-09-07.
2. V64 source catalogs, code и synthetic tests готовы; запечатать и запушить closure
   до server economics, проверить metadata-only preflight, выполнить один run/audit.
3. Сравнивать налоговое и фиксированное контрольное окна во всех трёх eras и costs;
   не менять даты/знак/размер/период после исхода. Не путать calendar proxy с наблюдением
   реальных валютных продаж. [Протокол и runbook](V64_TAX_CALENDAR.md).
...
3. Bounded source feasibility 2026-09-06 выполнена; собственная готовая история
   ...
   остановлено на входе DataShop. Следующий шаг — вход пользователя и проверка
   конкретных платных условий/подтверждения покупки либо ответ на уже отправленное письмо.
