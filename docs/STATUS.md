...
не его налоговую стратегию или результаты.4гипотезы ×2arms ×3eras ×2costs, без fit/нового
источника.8synthetic tests PASS; первый server economic run ещё не выполнен.
Только STAGE2_CANDIDATE получает подробную проверку. Старый2026 защищён, цель не достигнута.
...
1. Закончить один V65 run и показать все4гипотезы, сравнение с контролями,1×/2×costs,
   eras/years/CAGR/Sharpe/MDD/trades/coverage и причины отсева. Не менять правила после run.
