# V99 — Stage1 пройден; последующий V100 отклонил устойчивость

Обновление 2026-09-17, 00:03 МСК: [Stage2 V100 завершён](V100_V99_ROBUSTNESS_RESULT.md),
**REJECT_STAGE2_ROBUSTNESS**. 12 новых стресс-расчётов; baseline V99 не запускался
повторно. Дополнительная задержка 1 день нарушает лимиты просадки/плохого года,
7 дней снижает CAGR до 3.24–3.59%. Stage3/демо/live не разрешены. Исторический
Stage1 PASS и описание ниже сохранены; фразы «следующий шаг» ниже относятся к
моменту первоначального отчёта, а не к текущей очереди. Правило больше не настраивать.
