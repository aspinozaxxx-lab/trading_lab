...
BYTE_SEALED_NO_BOM_EXCEPTIONS = {  # Identity-pinned files cannot be rewritten post-outcome.
    "configs/moex_forward_stock_futures_cash_carry_source_v1.sha256",
    "configs/moex_forward_stock_futures_cash_carry_source_v1.yaml",
    "configs/moex_stock_futures_cash_carry_intraday_source_v3.sha256",
    "configs/moex_stock_futures_cash_carry_intraday_source_v3.yaml",
    "configs/moex_stock_futures_cash_carry_source_v2.sha256",
    "configs/moex_stock_futures_cash_carry_source_v2.yaml",
    "configs/stock_futures_cash_carry_idle_ruonia_v2.sha256",
    "configs/stock_futures_cash_carry_idle_ruonia_v2.yaml",
    "configs/stock_futures_cash_carry_intraday_v1.sha256",
    "configs/stock_futures_cash_carry_intraday_v1.yaml",
    "configs/v40_v39_cash_carry_stability_v1.sha256",
    "configs/v40_v39_cash_carry_stability_v1.yaml",
    "configs/v40r1_v39_cash_carry_stability_v1.sha256",
    "configs/v40r1_v39_cash_carry_stability_v1.yaml",
    "configs/v41_v39_cash_carry_ruonia_stability_v1.sha256",
    "configs/v41_v39_cash_carry_ruonia_stability_v1.yaml",
