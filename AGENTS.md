...
- 2026-09-15 пользователь явно разрешил [условный AlgoPack historical screen и архив](
  docs/ALGOPACK_RESEARCH_AND_ARCHIVE_AUTHORIZATION_20260915.md). Это узкое исключение
  для предварительного теста final-vintage2020–2025, не доказательство PIT/live и не
...
Приоритет пользователя2026-09-08: [воронка стратегий](docs/HYPOTHESIS_FUNNEL.md).
Сначала быстрый пакетный экономический конкурс на имеющихся разрешённых данных;
подробная проверка и усложнение только для прошедших кандидатов. Не заменять поиск
дохода настройкой инфраструктуры, новым сборщиком или минутным опросом будущего таймера.
Нужны результаты всех гипотез и причины отсева. Защита2026, причинность и costs сохраняются.
