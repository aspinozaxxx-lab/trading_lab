"""One dated current-account hypothesis, reusing the existing next-open ledger."""
...
CONFIG = base.PROJECT / "configs/v107_current_account_v1.json"
SEAL = base.PROJECT / "configs/v107_current_account_v1.seal.json"
MONTHS = dict(
    zip(
        [
            "января",
